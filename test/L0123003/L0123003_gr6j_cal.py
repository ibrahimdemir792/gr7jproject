...
if dir_path is not None:
    output_path = dir_path / 'gr6j_param_L0123003.json'
    with open (output_path, "w") as file:
        json.dump(parameters, file)


start_date = datetime.datetime(2004, 1, 1, 0, 0)
...
filtered_input = validation_data[validation_data.index >= datetime.datetime(2005, 1, 1, 0, 0)]
filtered_output = outputs[outputs.index >= datetime.datetime(2005, 1, 1, 0, 0)]
