...
data_path = next(working_directory.rglob('**/L0123002.pkl'), None)
if data_path:
...
dir_path = next(Path.cwd().rglob('outputs_L0123002'), None)
if dir_path is not None:
    output_path = dir_path / 'gr7j_param_L0123002.json'
