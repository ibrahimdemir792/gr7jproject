...
class SpotpySetup(object):
    ...
    def __init__(self, data):
        ...
        self.params = [spotpy.parameter.Uniform('x1', 201.018, 201.018),
                       spotpy.parameter.Uniform('x2', -0.222126, -0.222126),
                       spotpy.parameter.Uniform('x3', 110.452, 110.452),
                       spotpy.parameter.Uniform('x4', 2.21998, 2.21998),
...
end_date = datetime.datetime(2010, 12, 31, 0, 0)
...
end_date = datetime.datetime(1994, 12, 31, 0, 0)
mask = (df['date'] >= start_date) & (df['date'] <= end_date)
